...
// ── Özel Font Yükleme (Railway / Linux Uyumluluğu) ───────────
const fontRegularPath = path.join(__dirname, '..', 'assets', 'Roboto-Regular.ttf');
const fontBoldPath    = path.join(__dirname, '..', 'assets', 'Roboto-Bold.ttf');
